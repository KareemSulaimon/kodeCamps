...
const CountryPage = () => {
  ...
  const styles = {
    ...
    return (
      <div className='flex flex-col  sm:flex-row gap-20  w-full items-start sm:items-center p-6 sm:p-20 justify-between'>
        ...
        <div className='flex w-94 h-[400px] flex-col sm:items-start cursor-pointer gap-10 overflow-hidden rounded-t'> 
          ...
          <img className=' w-full h-full object-cover' src={country.flag} alt="country flag" />
        </div>
        ...
        <div className='flex flex-col sm:flex-row w-full justify-between'>
            ...
            <span className='flex flex-col gap-2'>
              <h1 className='text-black font-black text-2xl mb-6' style={styles}>{country.name}</h1>
